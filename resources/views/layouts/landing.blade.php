        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 ml-auto">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item mt-1 mt-sm-2 mx-lg-1"><a href="/login" aria-current="page"><button
                                        type="button" class="btn btn-sm btn-danger">Login</button></a></li>
                        @endif
                    @else
                ...
                <form class="d-flex d-sm-inline-block form-inline mt-2 mt-sm-2 navbar-search"
